...
- Name: visual-capture.spec.cjs >> Visual Capture — Full App Screenshots >> desktop — join (/join/TEST)
- Location: tests/visual-capture.spec.cjs:32:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/join/TEST
Call log:
  - navigating to "http://localhost:5174/join/TEST", waiting until "domcontentloaded"
